              ...
              <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-2 text-sm leading-relaxed text-muted-foreground">
                    <p>
                      東京大学大学院 情報理工学系研究科「データサイエンティスト本格養成プログラム」を修了。同プログラムは経済産業省認定「第四次産業革命スキル習得講座」に指定され、ITスキル標準（ITSS）レベル4相当のスキル習得を証明する。事業開発の現場経験とこの知見を掛け合わせ、分析から実装まで一貫したプロダクトづくりで経営を牽引している。
                    </p>
                    <p>
